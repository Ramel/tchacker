...
from tchacker_views import Tchacker_AddIssue, Tchacker_Edit, Tchacker_GoToIssue
                ...
                if filename:
                    ...
                    if is_image:
                        if file.metadata.format == "image/x-photoshop":
                            break
                        print("%s.Tchacker.%s.Issue.%s.id.%s contain an image that need a Thumbnail"
...
# Register
###########################################################################
#register_resource_class(Tchacker)
